...
<div class="h-100 bg-white">
  <div class="row h-100 m-1 p-1 border-top">
    <div class="col-3 h-100 m-0 p-0 border-end">
    ...
    <div class="col-9 h-100 bg-secondary.bg-gradient">
      <form class="w-100 h-100" method="post">
        ...
        <input type="text" id="memo-title" name="edit_title" placeholder="タイトルを入力..." value="" />
        <textarea id="memo-content" name="edit_content" placeholder="内容を入力..."></textarea>
      </form>
    </div>
  </div>
</div>
